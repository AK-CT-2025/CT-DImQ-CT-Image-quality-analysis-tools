...
#### Installation
Check out the [releases](https://github.com/AK-CT-2025/CT-DImQ-HistNMap/releases) of this repository. Find the latest release and download either `.dmg` file for MacOS or `.exe` file for Windows. 
